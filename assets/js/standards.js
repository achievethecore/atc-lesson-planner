window.standardsData = {
    ...
    "cai": {
	    "ela": {
            "ca1": {
                "a": "Focus each lesson on a high-quality text (or multiple texts).",
        ...
        "math": {
            ...
            "ca2": {
                ...
                "b": "Employ instructional practices that allow all students to learn the content of the lesson."
            },
            "ca3": {
                "a": "Provide all students with opportunities to exhibit mathematical practices while engaging with the content of the lesson.",
            ...
            "i3f": {
                ...
                "b": "The teacher establishes a classroom culture in which students choose and use appropriate tools when solving a problem.<br/><br/>Students use appropriate tools strategically when solving a problem."
            },
            "i3g": {
                "a": "The teacher asks students to explain and justify work and provides feedback that helps students revise initial work.<br/><br/>Student work includes revisions, especially revised explanations and justifications.",
                "b": "The teacher asks students to explain and justify work and provides feedback that helps students revise initial work.<br/><br/>Student work includes revisions, especially revised explanations and justifications."
            }
        }
    },
    "aspect_examples": [
	  {
	    ...
	    "grade": "K",
	    "standard": "K.OA.A.1",
	    "text": "Represent addition and subtraction with objects, fingers, mental images, drawings1, sounds (e.g., claps), acting out situations, verbal explanations, expressions, or equations.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	  ...
	  },
	  {
	    ...
	    "grade": 1,
	    "standard": "1.NBT.C",
	    "text": "Use place value understanding and properties of operations to add and subtract.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	  ...
	  },
	  {
	    ...
	    "grade": 3,
	    "standard": "3.OA.A.2",
	    "text": "Interpret whole-number quotients of whole numbers, e.g., interpret 56 ÷ 8 as the number of objects in each share when 56 objects are partitioned equally into 8 shares, or as a number of shares when 56 objects are partitioned into equal shares of 8 objects each.  For example, describe a context in which a number of shares or a number of groups can be expressed as 56 ÷ 8.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	    "grade": 4,
	    "standard": "4.NF.A",
	    "text": "Extend understanding of fraction equivalence and ordering.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	    "grade": 4,
	    "standard": "4.NBT.A",
	    "text": "Generalize place value understanding for multi-digit whole numbers.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	    "grade": 4,
	    "standard": "4.NBT.B",
	    "text": "Use place value understanding and properties of operations to perform multi-digit arithmetic.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	  ...
	  },
	  {
	    ...
	    "grade": 6,
	    "standard": "6.RP.A",
	    "text": "Understand ratio concepts and use ratio reasoning to solve problems.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	  ...
	  },
	  {
	    ...
	    "grade": 8,
	    "standard": "8.EE.B",
	    "text": "Analyze and solve linear equations and pairs of simultaneous linear equations.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	    "grade": 8,
	    "standard": "8.F.A",
	    "text": "Define, evaluate, and compare functions.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	    "grade": 8,
	    "standard": "8.G.A.",
	    "text": "Understand congruence and similarity using physical models, transparencies, or geometry software.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	  ...
	  },
	  {
	    ...
	    "grade": "HS",
	    "standard": "A-APR.B",
	    "text": "Understand the relationship between zeros and factors of polynomials.",
	    "": ""
	  },
	  {
	    "aspect": "conceptual understanding",
	  ...
	  },
	  {
	    ...
	    "grade": 6,
	    "standard": "6.EE.A",
	    "text": "Apply and extend previous understandings of arithmetic to algebraic expressions.",
	    "": ""
	  },
	  {
	    "aspect": "Procedural Skill and Fluency",
	  ...
	  },
	  {
	    ...
	    "grade": 7,
	    "standard": "7.EE.B.4a",
	    "text": "Solve word problems leading to equations of the form px   q = r andp(x   q) = r, where p, q, and r are specific rational numbers. Solve equations of these forms fluently. Compare an algebraic solution to an arithmetic solution, identifying the sequence of the operations used in each approach. For example, the perimeter of a rectangle is 54 cm. Its length is 6 cm. What is its width?",
	    "": ""
	  },
	  {
	    "aspect": "Procedural Skill and Fluency",
	  ...
	  },
	  {
	    ...
	    "grade": 8,
	    "standard": "8.EE.C.8b",
	    "text": "Solve systems of two linear equations in two variables algebraically, and estimate solutions by graphing the equations. Solve simple cases by inspection. For example, 3x   2y = 5 and 3x   2y = 6 have no solution because 3x   2y cannot simultaneously be 5 and 6.",
	    "": ""
	  },
	  {
	    "aspect": "Procedural Skill and Fluency",
	    "grade": "HS",
	    "standard": "A-SSE.A.1b",
	    "text": "Interpret complicated expressions by viewing one or more of their parts as a single entity. For example, interpret P(1 r)n as the product of P and a factor not depending on P.",
	    "": ""
	  },
	  {
	    "aspect": "Procedural Skill and Fluency",
	    "grade": "HS",
	    "standard": "F-BF.B.3",
	    "text": "Identify the effect on the graph of replacing f(x) by f(x)   k, k f(x), f(kx), andf(x   k) for specific values of k (both positive and negative); find the value of k given the graphs. Experiment with cases and illustrate an explanation of the effects on the graph using technology. Include recognizing even and odd functions from their graphs and algebraic expressions for them.",
	    "": ""
	  },
	  {
	    "aspect": "Procedural Skill and Fluency",
	    "grade": "HS",
	    "standard": "G-GPE.B.7",
	    "text": "Use coordinates to compute perimeters of polygons and areas of triangles and rectangles, e.g., using the distance formula.",
	    "": ""
	  },
	  {
	    "aspect": "Application",
	  ...
	  },
	  {
	    ...
	    "grade": 1,
	    "standard": "1.OA.A",
	    "text": "Represent and solve problems involving addition and subtraction.",
	    "": ""
	  },
	  {
	    "aspect": "Application",
	  ...
	  },
	  {
	    ...
	    "grade": 8,
	    "standard": "8.EE.C.8c",
	    "text": "Solve real-world and mathematical problems leading to two linear equations in two variables. For example, given coordinates for two pairs of points, determine whether the line through the first pair of points intersects the line through the second pair.",
	    "": ""
	  },
	  {
	    "aspect": "Application",
	    "grade": 8,
	    "standard": "8.F.B",
	    "text": "Use functions to model relationships between quantities.",
	    "": ""
	  },
	  {
	    "aspect": "Application",
	    "grade": "HS",
	    "standard": "N-Q.A",
	    "text": "Reason quantitatively and use units to solve problems.",
	    "": ""
	  },
	  {
	    "aspect": "Application",
    ...
    "compile": {
        "lexscore-check": {
            ...
            "meaning": [
                ...
                "Questar",
                "MetaMetrix",
                "University of Memphis (For Flesch-Kincaid measure)",
                "Pearson Knowledge Technologies",
                "Educators Testing Service"
            ]
        },
        "mp-check": {
            "label": [
            ...
            "meaning": [
                "Several levels and competing elements of meaning that are difficult to identify, separate, and interpret; theme is implicit or subtle, often ambiguous and revealed over the entirety of the text",
        ...
        "ar-check": {
            ...
            "meaning": [
                ...
                "The Standards call for speed and accuracy in calculation. Students are given opportunities to practice core functions such as single-digit multiplication so that they have access to more complex concepts and procedures. Examples of words that signal procedural skill and fluency include “fluently,” “compute,” “convert,” and “solve.” ",
                "The Standards call for students to use math flexibly for applications in problem-solving contexts of words phrases that signal application include “real world” and “word problems.”"
            ]
        }
    }
};

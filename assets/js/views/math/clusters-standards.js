define(
    ['jquery', 'view-templates/math/clusters-standards.html', '../../../data/standards-select.html', 'modules/state-manager', 'modules/utils', 'views/math/_base', 'lib/select2'], 
    function ($, template, standardsData, stateManager, utils, mathBase)
{
		...
		getHelpText: function() {
			return [ 
				...
				['div', 
					...
					'Focus is one of the major shifts associated with the CCSSM. Students need to have time to master the content of the ' + utils.gradeOrCourse(),
					['br'],

    ...
    function ($, template, tinymce, mathBase)
{
	var tools =
	{
        ...
        ['div',
					['h4', 'Beyond the Lesson'],
					['p', 'What tools are appropriate for students to independently access when solving mathematical problems in this unit? Do students frequently choose and use appropriate tools strategically in this class? For more information on SMP5, see ',
						['a', {href:'http://corestandards.org/Math/Practice', target:'_blank'}, 'http://corestandards.org/Math/Practice']
					]
        ]
			];
		},
